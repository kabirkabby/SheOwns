          ...
          <div className="max-w-7xl mx-auto w-full px-10 md:px-12  relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center py-12">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <h1 className="font-serif text-4xl sm:text-5xl lg:text-7xl font-light leading-[1.12] text-[#F8F5EF]">
                    SheOwns <br />
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col items-start space-y-5 pt-4">
                {/* Gold Primary Button */}
                <button
                ...
                <button
                  onClick={handleChoice}
                  className="text-sm text-[#F8F5EF] hover:text-[#D6BB88] pt-4 italic transition-colors duration-300 underline underline-offset-4 decoration-[#D6BB88]/30 hover:decoration-[#D6BB88] text-left"
                >
