...
const navLinks = [
  ...
  { name: "Why She Owns", href: "#why-she-owns" },
...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-350 transition-all duration-500 ${
        scrolled
          ? "bg-[#21102F]/90 backdrop-blur-md py-4 shadow-xl border-b border-[#D6BB88]/20"
          : "bg-transparent py-6"
      }`}
    >
      <div className="max-w-8xl mx-auto px-6 md:px-12 mr-10 flex items-center justify-between">
        {/* Brand Logo */}
        <a href="#" className="flex flex-col group">
          <div className="flex items-baseline space-x-1">
            <span className="font-serif text-xl md:text-3xl font-light tracking-wide text-[#F8F5EF] group-hover:text-[#D6BB88] transition-colors">
              SHE OWNS
            </span>
           
          </div>
          <span className="text-[10px] tracking-wider text-[#A98BC8] font-sans font-light">
            by Aurex Privy × Being She
          </span>
        </a>
        ...
        <div className="hidden sm:flex items-center space-x-4">
          <a
            ...
            className="flex items-center space-x-1.5 py-3 text-xs tracking-wider text-[#D6BB88] hover:text-[#F8F5EF] transition-colors px-3 py-2 border border-[#D6BB88]/30 rounded-full hover:border-[#D6BB88]"
          >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-[#21102F]/95 border-b border-[#D6BB88]/20 backdrop-blur-xl px-6 py-6"
          >
